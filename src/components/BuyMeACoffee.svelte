<script lang="ts">
  import { conversionCount } from "@/store";
...
>
  <p>
    Hey there! 👋 <br />
    I am glad you like my software. <br /> <br />
    ...
    <span class="font-thin">worksoffline.io</span>,<br />
    your can buy me a coffee. ☕️
  </p>
  <UiButton
    as="a"
    href="https://ko-fi.com/thurti"
    target="_blank"
